...
public interface IMoveGenerator<M extends IMove<G>, G extends IGame> {
     ...
     * Hint: if a player is dead but the others continue to play, you should either return a neutral move that does not change the game state, either manage it directly in the game state to skip the player once a move is executed
     * 
     * @param game
